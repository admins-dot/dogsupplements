        ...
        <ScaleReveal>
          <div className="relative bg-card rounded-3xl overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start">
              {/* Text Content - Left */}
              <div className="flex-1 px-12 py-10 md:p-12 lg:p-16 text-left">
              ...
              {/* Image - Right */}
              <div className="w-full md:w-1/2 lg:w-2/5 px-6 md:px-8 lg:pr-16 pb-6 md:pb-8 lg:pb-16 pt-0 md:pt-12 lg:pt-16 flex flex-col items-center">
                <img 
                  src={ctaDogProduct} 
