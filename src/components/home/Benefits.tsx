  ...
  return <section className="section-padding bg-primary">
      <div className="container-wide mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h2 className="text-3xl font-bold mb-4 md:text-5xl text-accent">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {benefits.map((benefit, index) => <div key={benefit.title} className="card-elevated p-8 text-center group hover:shadow-medium transition-all duration-300 opacity-0 animate-fade-in-up" style={{
